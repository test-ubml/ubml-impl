...
/**
 * Classname MetadataIndexItemDto Description 元数据索引 Date 2019/11/26 11:19
 *
 * @author zhongchq
 * @version 1.0
 */
public class MetadataIndexItemDto extends MetadataDto {
    ...
    public List<MetadataIndexRepoItemDto> getRepoPkg() {
        return repoPkg;
    }

    public void setRepoPkg(List<MetadataIndexRepoItemDto> repoPkg) {
